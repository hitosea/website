...
export async function ProductMatrix() {
  ...
  return (
    <section id="products" className="container py-20 md:py-32">
...
function ProductMatrixHeading() {
  ...
  return (
    <div className="mb-14 max-w-2xl md:mb-20">
      <h2 className="text-3xl font-bold tracking-tight md:text-5xl">{t('matrixTitle')}</h2>
      <p className="mt-4 text-lg text-muted-foreground">{t('matrixSubtitle')}</p>
    </div>
  )
}
